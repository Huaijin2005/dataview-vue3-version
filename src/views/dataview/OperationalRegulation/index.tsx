...
import { setRollEffect } from "@/utils/dataview_utils";
      ...
      <Skeleton title={title} mapType={mapType}>
        <div class="operational-regulation">
          <div class="dl-left">
            ...
            >
              <div class="chart-wlgjlx" style="width: 100%;height: 100%" />
              <img
                src={
                  new URL(
                    `@/assets/operational-regulation/curve.png`,
                    import.meta.url,
                  ).href
                }
            ...
            <Card title="漏洞补丁修复趋势" style="height: 25%">
              <div class="chart-ldbdxfqs" style="width: 100%;height: 100%" />
            </Card>
            <Card
              title="网络安全责任落实"
              style="height: 25%;position: relative"
          ...
          <div class="dl-right">
            ...
            <Card
              title="动环监控告警趋势"
              style="margin-top: 20px; height: 36%;"
            >
              <div class="chart-dhjkgj" style="width: 100%;height: 100%" />
            </Card>
            <Card title="网络设备实时告警" style="margin-top: 30px">
              <div class="netdevice-gaojing">
                <ElTable data={state.tableData} border>
                  <ElTableColumn
                    prop="number"
                    label="序号"
                    width={80}
