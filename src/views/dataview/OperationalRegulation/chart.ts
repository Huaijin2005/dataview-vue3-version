...
export function ldbdxfqsFn() {
  const chart = echarts.init(
    document.querySelector(".chart-ldbdxfqs") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: true,
...
export function dhjkgjFn() {
  const chart = echarts.init(
    document.querySelector(".chart-dhjkgj") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: true,
...
export function gaojingqushiFn() {
  const chart = echarts.init(
    document.querySelector(".chart-gaojingqushi") as HTMLElement,
  );
...
export function wlgjlxFn() {
  const chart = echarts.init(
    document.querySelector(".chart-wlgjlx") as HTMLElement,
  );
  const option = {
    grid: {
      left: "0",
    ...
    legend: {
      ...
      formatter: function (name: string) {
        var value = option.series[2].data.find(
          (item) => item.name === name,
        ).value;
...
export function wlaqzelsFn() {
  const chart = echarts.init(
    document.querySelector(".chart-wlaqzels") as HTMLElement,
  );
  const option = {
    legend: {
      show: false,
