...
export function jjxyFn() {
  const chart = echarts.init(
    document.querySelector(".chart-jjxy") as HTMLElement,
  );
  const military_statistics_data2 = [
    35, 40, 60, 50, 40, 50, 49, 60, 63, 70, 60, 40, 35, 33,
  ];
...
export function yjxxtjFn() {
  const chart = echarts.init(
    document.querySelector(".chart-yjxxtj") as HTMLElement,
  );
  const colorList = [
    "#afa3f5",
    "#3bafff",
...
export function rpaFn() {
  const chart = echarts.init(
    document.querySelector(".chart-rpa") as HTMLElement,
  );
...
export function bdyyFn() {
  const chart = echarts.init(
    document.querySelector(".chart-beidouyingyong") as HTMLElement,
  );
...
export function rgznybgjFn() {
  const chart = echarts.init(
    document.querySelector(".chart-rgznybgj") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: true,
...
export function zhwlFn() {
  const chart = echarts.init(
    document.querySelector(".chart-zhwl") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: true,
...
export function gwyhdlFn() {
  const chart = echarts.init(
    document.querySelector(".chart-gwyhdl") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: true,
...
export function tyspjrFn() {
  const chart = echarts.init(
    document.querySelector(".chart-tyspjr") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: false,
