...
export default defineComponent(() => {
  ...
  onMounted(() => {
    ...
    rgznybgjFn();
    jjxyFn();
    zhwlFn(), gwyhdlFn(), tyspjrFn(), bdyyFn();
  });
    ...
    return (
      <Skeleton title={title} mapType={mapType}>
        <div class="artificial-intelligence">
          <div class="ai-left">
            <Card title="庆电小云" style="height: 65%">
              <div class="kehuguanxi">
                <div class="ea-img">
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/AI.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/arr-1.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/arr-2.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/arr-3.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/taiqujinli.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                  <img
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/kehu.png`,
                        import.meta.url,
                      ).href
                    }
                  />
                ...
                <div class="ea-value">
                  <div class="eav-item">
                    ...
                    <span class="eavi-value" style="color: #02fe97;">
                      3
                    </span>
                    人
                  </div>
                  <div class="eav-item">
                    ...
                    <span class="eavi-value" style="color: #ffe169;">
                      15
                    </span>
                    人
                  </div>
                  <div class="eav-item">
                    ...
                    <span class="eavi-value" style="color: #4dbaff;">
                      427
                    </span>
                    人
                  </div>
                  <div class="eav-item">
                    ...
                    <span class="eavi-value" style="color: #fff;">
                      28356
                    </span>
                    人
                  </div>
              ...
              <div class="chart-jjxy" style="width: 100%;height: 28%" />
              <div
                class="qdcloud-title"
                style="transform: translateX(35%) translateY(24px);"
              >
                经济效益
              </div>
              <div class="yjxxtj-container">
                <img
                  ...
                  src={
                    new URL(
                      `@/assets/artificial-intelligence/jinjixiaoyi.png`,
                      import.meta.url,
                    ).href
                  }
                />
                ...
                <div class="chart-yjxxtj-legend">
                  {state.echartYjxxtjOption?.series[0].data.map(
                      ...
                      return (
                        <div class="cfl-item doudou-row">
                          <span
                            ...
                            style={{
                              background:
                                state.echartYjxxtjOption.series[0].color[index],
                            }}
                          ></span>
          ...
          <Card title="输电智能化" class="shudianzhinenghua">
            <div class="doudou-row doudou-row-shudianzhinenghua">
              <div class="doudou-col-3">
                <div class="common-subtitle" style="width: 100%">
                  无人机智能巡检
                </div>
                <div style="border: 2px solid #0084FF;margin-top: 30px;position: relative">
                  <ElCarousel height="300px" arrow="never">
                    {[
                      new URL(
                        `@/assets/artificial-intelligence/pic-1.png`,
                        import.meta.url,
                      ).href,
                      new URL(
                        `@/assets/artificial-intelligence/pic-1.png`,
              ...
              >
                <div>
                  <ElImage
                    ...
                    src={
                      new URL(
                        `@/assets/artificial-intelligence/map.png`,
                        import.meta.url,
                      ).href
                    }
                    fit="cover"
          ...
          <div class="ai-right">
            ...
            >
              <div class="chart-rgznybgj" style="width: 100%;height: 100%" />
            ...
            <Card title="智慧物联" style="height: 24%;">
              <div class="chart-zhwl" style="width: 100%;height: 100%" />
            </Card>
            <Card title="新技术应用" style="height: 42%;">
              <div class="szhnlkapt-title" style="margin-bottom: 28px;">
                国网用户登录情况
              </div>
              <div
                class="chart-gwyhdl"
