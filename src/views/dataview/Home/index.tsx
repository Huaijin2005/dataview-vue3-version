...
import { scaleContainer } from "@/utils/dataview_utils";
import Swiper from "swiper";
import { Autoplay, EffectFade } from "swiper/modules";
import { useRouter } from "vue-router";
import { drawDian } from "@/components/dataview/Skeleton/dian"; // 从Skeleton文件夹中引入dian.ts;
...
export default defineComponent(() => {
  ...
  const getImageUrl = (name: string) => {
    return new URL(`/src/assets/home/${name}`, import.meta.url).href;
  };
  /**
   * 监听某个状态的改变
   */
