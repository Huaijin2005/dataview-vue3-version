...
import Skeleton from "@/components/dataview/Skeleton";
import Card from "@/components/dataview/Card";
import Map from "./Map";
import {
  cflrsgzFn,
  fhsjcpslFn,
...
export default defineComponent(() => {
  ...
  const getImageUrl = (name: string) => {
    return new URL(
      `/src/assets/achievement-aggregation/${name}`,
      import.meta.url,
    ).href;
  };
  /**
  ...
  const handleChangeRpa = (value: State["activeRpa"]) => {
    ...
    const values = {
      in: [{ value: 310 }, { value: 60 }, { value: 30 }, { value: 30 }],
      out: [{ value: 200 }, { value: 90 }, { value: 10 }, { value: 10 }],
    };
      ...
      <Skeleton title={title} mapType={mapType}>
        <div class="achievement-aggregation">
          <div class="aa-left">
            <Card
              title="青年数创联盟团队"
              style="margin-top: 30px;height: 20%"
            ...
            >
              <div class="shuzihualianluoren">
                <div class="aa-img">
                  ...
                  <img
                    class="aa-img2"
                    src={getImageUrl("light efficiency-1.png")}
                  />
            ...
            <Card title="基层服务专区 " style="margin-top: 10px;height: 20%">
              <div class="chart-cflrsgz" style="width: 100%;height: 100%" />
            </Card>
            <Card title="RPA高频应用场景" style="margin-top: 10px;height: 20%">
              <div
                style={{
                ...
                {[
                  {
                    ...
                    color: "#38DDFB",
                    fontColor:
                      "linear-gradient(0deg, #EDB058 0%, rgba(255,255,255,0.55) 100%)",
                  },
                  {
                    label: "变压器远程停用",
                    value: 1675,
                    ...
                    color: "#38DDFB",
                    fontColor:
                      "linear-gradient(-33deg, rgb(165 165 165 / 83%) 0%, rgba(255, 255, 255, 0.83) 23.0225%, rgb(177 177 177 / 83%) 41.4062%, rgba(255, 255, 255, 0.83) 67.0654%, rgb(203 203 203 / 83%) 82.9346%, rgba(255, 255, 255, 0.83) 100%) text",
                  },
                  {
                    label: "统一视频监控机器人",
                    value: 1455,
                    ...
                    color: "#38DDFB",
                    fontColor:
                      "linear-gradient(0deg, #DC9F75 0%, rgba(255,255,255,0.55) 100%)",
                  },
                  {
                    label: "用户低电压原因",
                    value: 458,
                    ...
                    color: "#38DDFB",
                    fontColor:
                      "linear-gradient(0deg, #77CAFA 0%, rgba(255,255,255,0.55) 100%)",
                  },
                  {
                    label: "95598运营日报自动报送",
                    value: 425,
          ...
          <Card title="数字化能力开放平台" class="shuzihuanengli">
            <div
              ...
              style="width: 500px;transform: translateX(129%);"
            >
              数字化成果数量
            </div>
          ...
          <div class="aa-right">
            <Card title="大数据应用" style="height: 44%;">
                  ...
                  {[
                    {
                      name: "分析报告",
                      color: "#0084FF",
                      value: state.activeRpa === "in" ? 16 : 13,
                    },
                    {
                      name: "在线场景",
                      color: "#37FFC9",
                      value: state.activeRpa === "in" ? 3 : 2,
                    },
                    {
                      name: "数据集",
                      color: "#FFD768",
                      value: state.activeRpa === "in" ? 2 : 1,
                    },
                    {
                      name: "算法模型",
                      color: "#7CE4FE",
                    ...
                    return (
                      <div class="cfl-item doudou-row">
                        ...
                        ></span>
                        <span class="cfli-name" style="width: 150px">
                          {item.name}
                        </span>
                        <span class="cfli-value" style={{ color: item.color }}>
                          {item.value}
                        </span>
                      </div>
                    );
              ...
              <div
                class="bgdzsm-container"
                style="width: 100%;height: 390px;transform: translateY(-50px);"
              >
                <div class="chart-bgdzsm" style="width: 100%;height: 100%" />
              </div>
            </Card>
            <Card title="报表中心" style="height: 24%;">
              ...
              <div class="bgdzsm-container" style="width: 100%;height: 320px;">
                <div class="chart-bbzx" style="width: 100%;height: 100%" />
              </div>
              <div
                class="common-subtitle"
                style="width: 100%;margin-top: 10px;padding-bottom: 10px"
              >
                高频应用报表
              </div>
              <div
