...
import dynamicJson from "@/views/dataview/AchievementAggregation/data.json";
import {
  EllipseAnimation,
  EllipseItem,
} from "@/components/dataview/EllipseAnimation";
      ...
      return (
        <div class="aa-center">
          ...
          <div class="aac-animation-imgs">
            <img
              class="aacai-mv"
              src={getImageUrl("main-view.png")}
              alt=""
              srcset=""
            />
            <img
              class="aacaim-light"
              src={getImageUrl("light.png")}
              alt=""
              srcset=""
            />
            <img
              class="aacaim-building"
              src={getImageUrl("building.png")}
              alt=""
              srcset=""
            />
            <div class="aaca-circle">
              <div class="circle circle1">
                <img
                  ...
                  src={getImageUrl("base1.png")}
                  alt=""
                  srcset=""
                />
                <img
                  class="circle-img-bg"
                  src={getImageUrl("NO1.icon.png")}
                  alt=""
                  srcset=""
                />
                <img
                  class="circle-img-bg-icon"
                  src={getImageUrl("szhsfjs.png")}
                  alt=""
                  srcset=""
                />
