...
export function lineSzhcgslFn() {
  const chart = echarts.init(
    document.querySelector(".chart-line-szhcgsl") as HTMLElement,
  );
...
export function barSzhcgslFn() {
  const chart = echarts.init(
    document.querySelector(".chart-bar-szhcgsl") as HTMLElement,
  );
...
export function fhsjcpslFn() {
  const chart = echarts.init(
    document.querySelector(".chart-fhsjcpsl") as HTMLElement,
  );
  chart.setOption({
    grid: {
      left: 0,
    ...
    series: [
      ...
      },
      {
        ...
        radius: "60%",
        center: ["35%", "45%"],
        data: [{ value: 310 }, { value: 60 }, { value: 30 }, { value: 30 }],
        roseType: "radius",
        label: {
          show: false,
...
export function cflrsgzFn() {
  const chart = echarts.init(
    document.querySelector(".chart-cflrsgz") as HTMLElement,
  );
  chart.setOption({
    legend: {
      show: false,
...
export function bbzxFn() {
  const chart = echarts.init(
    document.querySelector(".chart-bbzx") as HTMLElement,
  );
  const option = {
    legend: {
      show: false,
...
export function bgdzsmFn() {
  const chart = echarts.init(
    document.querySelector(".chart-bgdzsm") as HTMLElement,
  );
  const option = {
    legend: {
      show: false,
